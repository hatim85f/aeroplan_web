...
function StatCard({ icon, label, value, accent = colors.accents.blue }) {
  return (
    ...
    <AppShell navigation={navigation} userDetails={userDetails} appMetadata={appMetadata} onSignOut={onSignOut} activeRoute="TargetDashboard">
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.statsRow}>
          <StatCard icon="trending-up-outline" accent={colors.accents.blue}  label="Total Target Units"    value={fmtNum(totalUnits)} />
          <StatCard icon="cash-outline"         accent={colors.accents.teal}  label="Total Target Value"   value={fmtCurrency(totalValue)} />
          <StatCard icon="person-outline"       accent={colors.accents.rose}  label="Active Assignments"   value={active} />
          <StatCard icon="analytics-outline"    accent={colors.accents.amber} label="YTD Achievement"       value="54.7%" />
          <StatCard icon="bar-chart-outline"    accent={colors.accents.blue}  label="Full Year Achievement" value="78.2%" />
        </View>
